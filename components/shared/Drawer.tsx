...
function Drawer({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          `fixed inset-0 bg-foreground z-40 ${isOpen ? "opacity-60" : "opacity-0 pointer-events-none"}`,
          overlayClassName,
        )}
        onClick={onClose}
      ...
      >
        {/* Drawer header */}
        <header className={cn("p-2 border-b border-dashed flex items-center", headerClassName)}>
